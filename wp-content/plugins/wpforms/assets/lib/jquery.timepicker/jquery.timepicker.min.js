...
!(function (a) {
  ...
  function d(b) {
    ...
    n > o && (o += u),
      o === u - 1 && "string" === a.type(c.timeFormat) && c.show2400 && (o = u);
    ...
    for (var i = n, z = 0; o >= i; z++, i += 60 * y(z)) {
      ...
      if (c.useSelect) {
        ...
        var C = a("<li />");
        C.addClass(43200 > A % 86400 ? "ui-timepicker-am" : "ui-timepicker-pm"),
          C.data("time", 86400 >= A ? A : A % 86400),
          C.text(B);
      }
      ...
      x > v &&
        ...
        p[v] &&
          ...
          (c.useSelect
            ? C.prop("disabled", !0)
            : C.addClass("ui-timepicker-disabled"))),
        d.append(C);
    }
    if (
      ...
      var F = c.appendTo;
      "string" == typeof F ? (F = a(F)) : "function" == typeof F && (F = F(b)),
        F.append(g),
        j(b, d),
  ...
  function j(a, b) {
    ...
    if (null !== c) {
      ...
      if (d) {
        ...
        (e + d.outerHeight() > b.outerHeight() || 0 > e) &&
          b.scrollTop(b.scrollTop() + d.position().top - d.outerHeight()),
  ...
  function o(c) {
    ...
    switch (c.keyCode) {
      case 13:
        return (
          q(d) && (k.call(d.get(0), { type: "change" }), w.hide.apply(this)),
          c.preventDefault(),
          !1
        );
      case 38:
  ...
  function r(a, b) {
    ...
    return (
      60 > e
        ...
        : ((c = Math.floor(e / 60)),
          (d = e % 60),
          30 == b && 30 == d && (c += v.decimal + 5),
          f.push(c),
          f.push(1 == c ? v.hr : v.hrs),
          30 != b && d && (f.push(d), f.push(v.mins))),
      f.join(" ")
    );
  }
  function s(b, c) {
    ...
    return this.length
      ? w[b]
        ? this.hasClass("ui-timepicker-input")
          ? w[b].apply(this, Array.prototype.slice.call(arguments, 1))
          : this
        : "object" != typeof b && b
