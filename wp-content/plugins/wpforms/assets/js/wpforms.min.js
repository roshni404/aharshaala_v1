    ...
    var p = {
      ...
      ready: function () {
        p.clearUrlQuery(),
          ...
          p.loadMailcheck(),
          p.loadChoicesJS(),
          l(".wpforms-randomize").each(function () {
            for (var e = l(this), t = e.children(); t.length; )
              e.append(t.splice(Math.floor(Math.random() * t.length), 1)[0]);
          }),
          l(".wpforms-page-button").prop("disabled", !1),
          l(n).trigger("wpformsReady");
      },
      load: function () {},
      ...
      loadValidation: function () {
        void 0 !== l.fn.validate &&
          (l(".wpforms-input-temp-name").each(function (e, t) {
            var r = Math.floor(9999 * Math.random()) + 1;
            l(this).attr("name", "wpf-temp-" + r);
          }),
          l(n).on("change", ".wpforms-validate input[type=url]", function () {
            var e = l(this).val();
            if (!e) return !1;
            "http://" !== e.substr(0, 7) &&
              "https://" !== e.substr(0, 8) &&
          ...
          (l.validator.messages.required = wpforms_settings.val_required),
          (l.validator.messages.url = wpforms_settings.val_url),
          (l.validator.messages.email = wpforms_settings.val_email),
          (l.validator.messages.number = wpforms_settings.val_number),
          void 0 !== l.fn.payment &&
          ...
          l.validator.addMethod(
            "confirm",
            function (e, t, r) {
              t = l(t).closest(".wpforms-field");
              return (
                l(t.find("input")[0]).val() === l(t.find("input")[1]).val()
              );
            },
              ...
              return (
                ...
                (p.compareTimesGreaterThan(a, r)
                  ? p.compareTimesGreaterThan(e, r) &&
                    p.compareTimesGreaterThan(a, e)
                  : (p.compareTimesGreaterThan(e, r) &&
                      p.compareTimesGreaterThan(e, a)) ||
          ...
          l.validator.addMethod(
            ...
            function (e, t) {
              t = parseInt(
                l(t).closest("ul").attr("data-choice-limit") || 0,
                10
              );
          ...
          void 0 !== l.fn.intlTelInput &&
            l.validator.addMethod(
              ...
              function (e, t) {
                return (
                  !e.match(/[^\d()\-+\s]/) &&
                  (this.optional(t) || l(t).intlTelInput("isValidNumber"))
                );
              },
          ...
          l.validator.addMethod(
            ...
            function (e, t) {
              return (
                0 === e.length ||
                void 0 === l.fn.inputmask ||
                l(t).inputmask("isComplete")
              );
            },
          ...
          l.validator.addMethod(
            ...
            function (e, t, r) {
              ...
              return (
                ...
                Number(p.amountSanitize(r)) <= Number(p.amountSanitize(e))
              );
            },
          ...
          l(".wpforms-validate").each(function () {
            var e = l(this),
              t = e.data("formid"),
              t =
                void 0 !== s["wpforms_" + t] &&
                  ...
                  : {
                        ...
                        function e() {
                          ...
                          return (
                            ...
                            a
                              ? s(e, t)
                              : p.empty(i) && 0 !== i
                              ? (l(".wpforms-input-temp-name").removeAttr(
                                  "name"
                                ),
                                void p.formSubmit(e))
                              : (grecaptcha.execute(i).then(null, function () {
                                  grecaptcha.getResponse() || s(e, t);
                                }),
                                !1)
                          );
                        }
                      ...
                      invalidHandler: function (e, t) {
                        void 0 !== t.errorList[0] &&
                          p.scrollToError(l(t.errorList[0].element));
                      },
                      onkeyup: WPFormsUtils.debounce(function (e, t) {
                        l(e).hasClass("wpforms-novalidate-onkeyup") ||
      ...
      loadDatePicker: function () {
        void 0 !== l.fn.flatpickr &&
          l(".wpforms-datepicker-wrap").each(function () {
            var a = l(this),
              e = a.find("input"),
      ...
      loadTimePicker: function () {
        void 0 !== l.fn.timepicker &&
          l(".wpforms-timepicker").each(function () {
            var e = l(this),
      ...
      loadInputMask: function () {
        void 0 !== l.fn.inputmask &&
          l(".wpforms-masked-input").inputmask({ rightAlign: !1 });
      },
      loadSmartPhoneField: function () {
        ...
        void 0 !== l.fn.intlTelInput &&
          ...
          l(".wpforms-smart-phone-field").each(function (e, t) {
            var r = l(t);
            (a.hiddenInput = r
              ...
              r.on("blur input", function () {
                (!r.intlTelInput("isValidNumber") &&
                  p.empty(s.WPFormsEditEntry)) ||
                  r
                    .siblings('input[type="hidden"]')
                    .val(r.intlTelInput("getNumber"));
              });
          }),
          l(".wpforms-form").on("wpformsBeforeFormSubmit", function () {
            l(this).find(".wpforms-smart-phone-field").trigger("input");
          }));
      },
      loadPayments: function () {
        l(".wpforms-payment-total").each(function (e, t) {
          p.amountTotal(this);
        }),
          void 0 !== l.fn.payment &&
            (l(".wpforms-field-credit-card-cardnumber").payment(
              "formatCardNumber"
            ),
            l(".wpforms-field-credit-card-cardcvc").payment("formatCardCVC"));
      },
      loadMailcheck() {
        wpforms_settings.mailcheck_enabled &&
          ...
          l(n).on("blur", ".wpforms-field-email input", function () {
            const e = l(this),
              o = e.attr("id");
            e.mailcheck({
              suggested(e, t) {
      ...
      loadChoicesJS: function () {
        "function" == typeof s.Choices &&
          ...
          l(n).on("click", ".choices", function (e) {
            var t = l(this),
      ...
      bindUIActions: function () {
        ...
        e.on("click", ".wpforms-page-button", function (e) {
          ...
          l(n).on("change", ".wpforms-field-rating-item input", function () {
            var e = l(this),
              t = e
          ...
          l(function () {
            l(".wpforms-field-rating-item input:checked").trigger("change");
          }),
          ...
          e.on("input", ".wpforms-field-file-upload", function () {
            var e = l(this),
              ...
              n = e.prev(),
              s = i.closest("form"),
              p = s.find(".wpforms-page-next:visible");
            0 !== s.find(".wpforms-page-indicator").length &&
              0 !== p.length &&
              (i = p),
              t.each(function () {
                for (var e = l(this), t = 0, r = e[0].files.length; t < r; t++)
                  a += e[0].files[t].size;
              }),
              a < r
                ? (n.find(".wpforms-error-container-post_max_size").remove(),
                  ...
                  WPFormsUtils.triggerEvent(s, "wpformsCombinedUploadsSizeOk", [
                    s,
                    n,
                  ]))
          ...
          e.on(
            ...
            function (e) {
              var t = l(e.target).siblings(".wpforms-field-number-slider-hint");
              t.html(
                t
                  .data("hint")
          ...
          e.on("keydown", ".wpforms-form input", function (e) {
            var t, r;
            13 !== e.keyCode ||
              0 === (r = (t = l(this)).closest(".wpforms-page")).length ||
              [
                "text",
                "tel",
                "number",
      ...
      formChanged: function (e) {
        var t = l(this).closest(".wpforms-form");
        p.maybeSetStartTime(t);
      },
      richTextContentChanged: function (e, t, r) {
        (r = r.getContainer()), (r = l(r).closest(".wpforms-form"));
      ...
      checkForInvalidFields: function (e, t, r) {
      ...
      bindOptinMonster: function () {
        n.addEventListener("om.Campaign.load", function (e) {
          ...
          l(n).on("OptinMonsterOnShow", function (e, t, r) {
      ...
      optinMonsterRecaptchaReset: function (e) {
        ...
        e.length &&
          ...
          r.render(t, {
            sitekey: e,
            callback: function () {
              wpformsRecaptchaCallback(l("#" + t));
            },
          }));
      },
      amountTotal(e, t) {
        t = t || !1;
        const r = l(e).closest(".wpforms-form"),
      ...
      amountTotalCalc: function (e) {
        var a = 0,
          t =
            (l(".wpforms-payment-price", e).each(function () {
              var e = 0,
                t = l(this),
                r = t.attr("type");
              t
            ...
            l(n)),
          r = WPFormsUtils.triggerEvent(t, "wpformsAmountTotalCalculate", [
            e,
            a,
          ]),
          a = void 0 !== r.result && 0 <= r.result ? r.result : a;
        return (
          WPFormsUtils.triggerEvent(t, "wpformsAmountTotalCalculated", [e, a]),
          a
        );
      },
      ...
      currentIpToCountry: function (r) {
        function t() {
          l.get("https://ipapi.co/jsonp", function () {}, "jsonp").always(
            function (e) {
              var t,
                e = e && e.country ? e.country : "";
              e ||
                (e =
                  -1 < (t = p.getFirstBrowserLanguage()).indexOf("-")
                    ? t.split("-").pop()
                    : ""),
                r(e);
            }
        ...
        l.get("https://geo.wpforms.com/v3/geolocate/json")
          .done(function (e) {
            ...
            "string" == typeof t
              ? ((a = p.isModernMarkupEnabled() ? ' role="alert"' : ""),
                ...
                e
                  .find(".wpforms-submit-container")
                  .before(
                    `<div class="wpforms-error-container"${a}>${o}${t}</div>`
                  ),
                p.setCurrentPage(e, {}))
      ...
      displayFormAjaxFieldErrors: function (e, t) {
        ...
        e &&
          ...
          (p.empty(t) ||
            ((r = e.data("validator")) &&
              (r.showErrors(t), p.formHasCaptcha(e) || r.focusInvalid())));
      },
      ...
      setCurrentPage: function (r, a) {
        if (0 !== r.find(".wpforms-page-indicator").length) {
          ...
          if (
            ...
            p.navigateToPage(a, t, o, r, l(".wpforms-page-" + o));
          }
        }
      },
